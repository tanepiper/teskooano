import { CelestialObject, CelestialType, GasGiantProperties, RingSystemProperties } from '@teskooano/data-types';
...
export class GasGiantInfoComponent extends HTMLElement implements CelestialInfoComponent {
