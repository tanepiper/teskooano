import { CelestialObject, CelestialType, OortCloudProperties, AU_METERS } from '@teskooano/data-types';
...
export class OortCloudInfoComponent extends HTMLElement implements CelestialInfoComponent {
