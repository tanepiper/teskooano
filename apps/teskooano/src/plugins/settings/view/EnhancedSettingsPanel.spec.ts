...
describe("Enhanced Settings Panel UI Layer", () => {
  ...
  describe("Component Initialization", () => {
    ...
    it("should display current mode in badge", () => {
      const badge = panel.shadowRoot!.querySelector(
        "#current-mode-badge",
      ) as HTMLElement;
    ...
    it("should show N-Body controls for N-Body mode", () => {
      const nbodyControls = panel.shadowRoot!.querySelector(
        "#nbody-controls",
      ) as HTMLElement;
  ...
  describe("Mode Switching", () => {
    it("should switch to ideal mode and hide N-Body controls", async () => {
      const modeSelect = panel.shadowRoot!.querySelector(
        "#setting-simulation-mode",
  ...
  describe("N-Body Algorithm and Integrator Selection", () => {
    it("should update algorithm selection", async () => {
      const algorithmSelect = panel.shadowRoot!.querySelector(
        "#setting-algorithm",
      ) as HTMLSelectElement;
    ...
    it("should update integrator selection", async () => {
      const integratorSelect = panel.shadowRoot!.querySelector(
        "#setting-integrator",
      ) as HTMLSelectElement;
  ...
  describe("Configuration Display", () => {
    it("should update configuration display for ideal mode", async () => {
      ...
      const configDisplay = panel.shadowRoot!.querySelector(
        "#config-display",
      ) as HTMLElement;
  ...
  describe("Validation and Error Handling", () => {
    it("should show validation messages for invalid operations", async () => {
      const validationMessages = panel.shadowRoot!.querySelector(
        "#validation-messages",
      ) as HTMLElement;
  ...
  describe("Accessibility", () => {
    it("should have proper labels for all form controls", () => {
      const formControls = panel.shadowRoot!.querySelectorAll(
        "select, teskooano-slider",
      );
