...
/**
 * Renders UI controls specifically for White Dwarf stars.
 * Focuses on their unique properties like high density and cooling characteristics.
 */
export class WhiteDwarfUniformsRenderer extends BaseUniformsRenderer {
  public render(
    ...
    this._createWhiteDwarfEffectsSection(container, celestial, subscriptions);
  ...
  private _createBasicPropertiesSection(
    ...
    basicHeader.textContent = "White Dwarf Colors";
    ...
    // Hot Color - for hot spots and accretion
    ...
    // Cool Color - for cooling regions
  ...
  private _createWhiteDwarfEffectsSection(
    container: HTMLElement,
    celestial: CelestialObject,
    subscriptions: Subscription[],
  ): void {
    const effectsHeader = document.createElement("h3");
    effectsHeader.textContent = "White Dwarf Effects";
