...
**Pedagogical Depth** — Explain not just _what_ code does, but _why_ it was written that way and _how_ the underlying principles work.
...
- Shallow explanations that describe _what_ without _why_
