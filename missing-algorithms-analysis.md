...
export type AlgorithmType = 
  ...
  | "tree-pm" | "amr" | "scf" | "ngpm"    // New algorithms
  | "bottom-up-tree" | "gpu-fmm";        // Specialized variants

// Add to IntegratorType  
export type IntegratorType = 
  | "euler" | "symplectic" | "verlet" | "rk4" | "adaptive"
  | "yoshida4" | "forest-ruth" | "pefrl"  // Higher-order symplectic
  | "hermite" | "beeman" | "leapfrog";    // Additional methods
```
