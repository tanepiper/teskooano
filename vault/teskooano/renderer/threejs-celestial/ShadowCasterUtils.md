...
classes: ["CelestialDistanceService", "THREE.Vector3"]
...
- **CelestialDistanceService**: Integration with WASM spatial service
...
- [[CelestialDistanceService]] - WASM spatial service integration
