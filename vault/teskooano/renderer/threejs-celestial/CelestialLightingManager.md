...
classes: ["LightingCalculator", "ShadowCasterUtils", "CelestialDistanceService"]
...
- **CelestialDistanceService**: Uses spatial service for shadow detection
...
- [[CelestialDistanceService]] - Spatial queries for shadow detection
