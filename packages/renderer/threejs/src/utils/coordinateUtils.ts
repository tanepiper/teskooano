 ...
 */
// export function physicsToThreeJSQuaternion(
//     physicsOrientation: OSQuaternion, // Replace with actual type if/when implemented
//     target?: THREE.Quaternion
// ): THREE.Quaternion {
//     const result = target || new THREE.Quaternion();
//     // Direct copy assumes identical structure and Y-up convention
//     result.set(physicsOrientation.x, physicsOrientation.y, physicsOrientation.z, physicsOrientation.w);
//     return result;
// }

// Placeholder for potential OSQuaternion if needed later
// export class OSQuaternion { x: number; y: number; z: number; w: number; /* ... methods ... */ }
