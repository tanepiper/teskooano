 ...
 */
export const CAMERA_OFFSET = new OSVector3(0.8, 0.4, 1.0).normalize();
/**
 * Default camera position if no specific initial position is provided.
 */
export const DEFAULT_CAMERA_POSITION = new OSVector3(200, 200, 200);
/**
 * Default camera target point if no specific initial target is provided.
 */
export const DEFAULT_CAMERA_TARGET = new OSVector3(0, 0, 0);
/**
