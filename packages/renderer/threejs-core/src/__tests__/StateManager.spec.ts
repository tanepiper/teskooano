...
describe('StateManager', () => {
  ...
  it('should notify object subscribers when objects are added', () => {
    ...
    const objCallback = (celestialObjectsStore.subscribe as any).mock.calls[0][0];
    ...
    expect(objectCallback).toHaveBeenCalledWith('add', newObject, 'test-object');
  });
  ...
  it('should notify object subscribers when objects are updated', () => {
    ...
    expect(objectCallback).toHaveBeenCalledWith('update', updatedObject, 'test-object');
  });
  ...
  it('should notify object subscribers when objects are removed', () => {
    ...
    expect(objectCallback).toHaveBeenCalledWith('remove', existingObject, 'test-object');
  });
