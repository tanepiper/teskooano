...
export function updateDebugLabel(debugLabel: DebugLabel, lod: THREE.LOD, cameraPosition: THREE.Vector3): void {
...
export function setDebugLabelVisibility(debugLabels: Map<string, DebugLabel>, visible: boolean): void {
