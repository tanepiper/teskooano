...
vi.mock("@teskooano/systems-celestial", () => {
  ...
  const createTerrestrialMesh = vi
    .fn()
    .mockImplementation(() => new THREE.Object3D());
...
describe("MeshFactory", () => {
  ...
  it("should create a star mesh", () => {
    ...
    expect(createStarRenderer).toHaveBeenCalledWith(
  ...
  it("should create an asteroid field mesh", () => {
    ...
    const asteroidRenderer = celestialRenderers.get(
