...
vi.mock("@teskooano/systems-celestial", () => {
  ...
  class MockSchwarzschildBlackHoleRenderer extends MockCelestialRenderer {
    addGravitationalLensing(
      ...
      mockCelestialRenderers.addGravitationalLensing(
        object,
        renderer,
        scene,
        camera,
...
describe("GravitationalLensingHandler", () => {
  ...
  it("should identify objects needing gravitational lensing", () => {
    ...
    expect(lensingHandler.needsGravitationalLensing(blackHoleObject)).toBe(
      true,
    );
    expect(lensingHandler.needsGravitationalLensing(regularStarObject)).toBe(
      false,
    );
  ...
  it("should apply gravitational lensing to objects that need it", () => {
    ...
    starRenderers.set(
      "black-hole",
      blackHoleRenderer as unknown as CelestialRenderer,
    );
