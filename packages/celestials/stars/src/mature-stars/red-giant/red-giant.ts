...
/**
 * Red Giant star renderer
 * Uses volumetric ray-marching material for realistic appearance
 * - Temperature: 3,000-5,000 K
 * - Color: Red to orange
 * - Typical mass: 0.6-10 M☉
 * - Hydrogen shell burning with large convective envelope
 * - Examples: Aldebaran, Arcturus
 */
export class RedGiantRenderer extends BaseStarRenderer<RealisticStarMaterial> {
