...
export class PostAGBRenderer extends BaseStarRenderer<PostAGBMaterial> {
  ...
  protected getCustomLODs(
    ...
    highDetailGroup.name = `${object.celestialObjectId}-post-agb-high`;
    ...
    starMesh.name = `${object.celestialObjectId}-post-agb-body`;
    ...
    mediumDetailGroup.name = `${object.celestialObjectId}-post-agb-medium`;
  ...
  private _createBrightCorona(
    ...
    coronaLayers.forEach((layer, index) => {
      ...
      coronaMesh.name = `${object.celestialObjectId}-post-agb-corona-${index}`;
