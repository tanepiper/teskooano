...
/**
 * Hypergiant star renderer
 * Uses volumetric ray-marching material for realistic appearance
 * - Temperature: 3,500-35,000 K (varies widely)
 * - Color: Red to blue depending on type
 * - Typical mass: >8 M☉
 * - Extremely massive and luminous stars with powerful stellar winds
 * - Unstable with violent mass loss events
 * - Examples: Betelgeuse (red), Rigel (blue)
 */
export class HypergiantRenderer extends BaseStarRenderer<RealisticStarMaterial> {
  ...
  protected getStarColor(
    ...
    // Hypergiants vary widely - default to blue-white
