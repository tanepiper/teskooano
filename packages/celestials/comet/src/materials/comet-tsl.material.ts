...
export class CometNucleusTSLMaterial extends MeshStandardNodeMaterial {
  constructor(baseColor: THREE.Color = new THREE.Color(0x202020)) {
    ...
    console.log(
      "[CometNucleusTSLMaterial] Created WebGPU TSL comet nucleus material",
    );
  }
}
...
export class CometComaTSLMaterial extends MeshBasicNodeMaterial {
  constructor(
    glowColor: THREE.Color = new THREE.Color(0x88ccff),
    opacity: number = 0.3,
  ) {
    super();
    ...
    console.log(
      "[CometComaTSLMaterial] Created WebGPU TSL comet coma material",
    );
  }
}
