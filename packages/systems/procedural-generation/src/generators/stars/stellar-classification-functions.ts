...
export class StellarClassifier {
   ...
   */
  public determineLuminosityClass(
   ...
   */
  public determineMainSequenceSpectralClass(
    temperature: number,
   ...
   */
  public determineBrownDwarfSpectralClass(
    temperature: number,
   ...
   */
  public determineBlackHoleCharacteristics(physicsData: StellarPhysicsData): {
   ...
   */
  public determineWhiteDwarfType(
    physicsData: StellarPhysicsData,
    composition?: {
      hydrogen?: number;
      helium?: number;
  ...
  public createMainSequenceStar(
    ...
    return {
      ...
      spectralClass: this.determineMainSequenceSpectralClass(
        physicsData.temperature,
      ),
      luminosityClass: this.determineLuminosityClass(
        physicsData,
  ...
  public createStellarRemnant(
    ...
    switch (remnantType) {
      case StellarType.WHITE_DWARF:
        characteristics = {
          atmosphericType: this.determineWhiteDwarfType(
            physicsData,
      ...
      case StellarType.NEUTRON_STAR:
        characteristics = {
          isPulsar:
            additionalData?.rotationPeriod &&
            additionalData.rotationPeriod < 10,
          isMagnetar:
      ...
      case StellarType.BLACK_HOLE:
        characteristics = this.determineBlackHoleCharacteristics(physicsData);
        break;
    }
  ...
  public createEvolvedStar(
    ...
    switch (evolvedType) {
      ...
      case StellarType.SUBGIANT:
        ...
        spectralClass =
          this.determineMainSequenceSpectralClass(physicsData.temperature) ||
          "M";
        break;
    ...
    return {
      ...
      spectralClass,
      luminosityClass: this.determineLuminosityClass(physicsData, evolvedType),
      characteristics,
      physicsData,
      renderingData,
    };
   ...
   */
  public createPreMainSequenceStar(
    ...
    return {
      ...
      spectralClass,
      luminosityClass: this.determineLuminosityClass(physicsData, preMainType),
      characteristics,
      physicsData,
      renderingData,
    };
