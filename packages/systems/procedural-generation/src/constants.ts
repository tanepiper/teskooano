...
export const ICE_COMPOSITION = ['water ice', 'ammonia ice', 'methane ice', 'rock'];
...
export const ATMOSPHERE_COMPOSITION: Record<AtmosphereType, string[][]> = {
  [AtmosphereType.NONE]: [],
  [AtmosphereType.THIN]: [['N2', 'Ar'], ['CO2', 'Ar'], ['CH4', 'N2']],
  [AtmosphereType.NORMAL]: [['N2', 'O2'], ['N2', 'O2', 'Ar'], ['CO2', 'N2']],
  [AtmosphereType.DENSE]: [['CO2', 'N2'], ['SO2', 'CO2'], ['N2', 'CH4']],
  [AtmosphereType.VERY_DENSE]: [['CO2', 'SO2'], ['N2'], ['H2S', 'CO2']],
};

// --- Atmosphere Visual Properties ---
export const ATMOSPHERE_DENSITY_RANGES: Record<AtmosphereType, { min: number; max: number }> = {
