...
export class CelestialRendererDebugHelper {
  ...
  public updateOrbitalDebugData(object: RenderableCelestialObject): void {
    ...
    if (object.orbit) {
      ...
      orbitalData.longitudeAscendingNode = object.orbit.longitudeOfAscendingNode;
  ...
  public updateLightingDebugData(
    ...
    if (object.primaryLightSourceId && lightSources && lightSources.has(object.primaryLightSourceId)) {
