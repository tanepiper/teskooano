...
describe("CelestialObject Creation", () => {
  it("should create a Star object with components", () => {
    ...
    const starComp = star.getComponent<{ type: string; luminosity: number }>(
      "star",
    );
  ...
  it("should create a Planet object with components", () => {
    ...
    const planetComp = star.getComponent<{
      type: string;
      atmosphere: object;
      surface: object;
    }>("planet");
  ...
  it("should create a Moon object with components", () => {
    ...
    const moonComp = star.getComponent<{
      type: string;
      parentId: string;
  ...
  it("should create a Station object with components", () => {
    const station = CelestialObjectFactory.createStation("iss", "ISS", 4, 7, [
      "science",
      "refuel",
    ]);
    ...
    const stationComp = star.getComponent<{
      type: string;
      dockingBays: number;
      population: number;
    }>("station");
  ...
  it("should create an Asteroid object with components", () => {
    ...
    const asteroidComp = star.getComponent<{
      type: string;
      composition: string[];
