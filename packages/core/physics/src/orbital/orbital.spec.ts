...
describe('Orbital Mechanics', () => {
  ...
  describe('calculateOrbitalVelocity', () => {
    it('should calculate correct circular orbital velocity', () => {
      const velocity = calculateOrbitalVelocity(mockSunState, earthSemiMajorAxis);
      const expectedSpeed = Math.sqrt(GRAVITATIONAL_CONSTANT * sunMass / earthSemiMajorAxis);
    ...
    it('should return 0 for zero parent mass', () => {
      ...
      const velocity = calculateOrbitalVelocity(masslessSun, earthSemiMajorAxis);
  ...
  describe('calculateOrbitalPosition', () => {
    ...
    it('should calculate correct position for a circular orbit at t=T/4', () => {
      ...
      const position = calculateOrbitalPosition(mockSunState, orbitalParams, time);
