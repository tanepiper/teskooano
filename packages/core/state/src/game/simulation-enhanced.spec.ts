...
import type { SimulationConfiguration, AlgorithmType, IntegratorType } from './types';
...
describe('Enhanced SimulationStateService', () => {
  ...
  describe('setSimulationConfiguration', () => {
    ...
    it('should throw error for invalid configuration', () => {
      ...
      expect(() => service.setSimulationConfiguration(invalidConfig))
  ...
  describe('setNBodyAlgorithm', () => {
    ...
    it('should throw error when not in nbody mode', () => {
      ...
      expect(() => service.setNBodyAlgorithm('direct'))
        .toThrow(/Cannot set N-Body algorithm when not in N-Body mode/);
    });
  ...
  describe('setNBodyIntegrator', () => {
    ...
    it('should change integrator in nbody mode', () => {
      const integrators: IntegratorType[] = ['euler', 'symplectic', 'rk4', 'adaptive'];
    ...
    it('should throw error when not in nbody mode', () => {
      ...
      expect(() => service.setNBodyIntegrator('rk4'))
        .toThrow(/Cannot set N-Body integrator when not in N-Body mode/);
    });
  ...
  describe('reactive state updates', () => {
    ...
    it('should maintain reactivity when using specific setters', (done: () => void) => {
      ...
      const subscription = service.simulationState$.subscribe((state: any) => {
        changeCount++;
        if (changeCount === 2) { // Skip initial emission
